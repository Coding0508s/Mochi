                        ...
                        <div class="space-y-4">
                            ...
                            <div class="grid grid-cols-2 gap-3">
                                <div>
                                    ...
                                    <input type="text" wire:model="teacherProfileForm.name"
                                           class="w-full py-2 px-3 text-sm border rounded-lg focus:outline-none focus:ring-2 focus:ring-mochi-header {{ $errors->has('teacherProfileForm.name') ? 'border-red-400' : 'border-gray-300' }}">
                                    @error('teacherProfileForm.name') <p class="mt-1 text-xs text-red-500">{{ $message }}</p> @enderror
                                </div>
                                <div>
                            ...
                            <div class="grid grid-cols-2 gap-3">
                                <div>
                                    ...
                                    <input type="email" wire:model="teacherProfileForm.email"
                                           class="w-full py-2 px-3 text-sm border rounded-lg focus:outline-none focus:ring-2 focus:ring-mochi-header {{ $errors->has('teacherProfileForm.email') ? 'border-red-400' : 'border-gray-300' }}">
                                    @error('teacherProfileForm.email') <p class="mt-1 text-xs text-red-500">{{ $message }}</p> @enderror
                                </div>
                                <div>
                            ...
                            <div>
                                ...
                                <textarea wire:model="teacherProfileForm.description" rows="4"
                                          class="w-full py-2 px-3 text-sm border rounded-lg focus:outline-none focus:ring-2 focus:ring-mochi-header resize-none {{ $errors->has('teacherProfileForm.description') ? 'border-red-400' : 'border-gray-300' }}"></textarea>
                                @error('teacherProfileForm.description') <p class="mt-1 text-xs text-red-500">{{ $message }}</p> @enderror
                            </div>
                        </div>
                    @else
                    <div>
