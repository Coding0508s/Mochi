...
<h3 style="margin-top: 1.5em; margin-bottom: 0.25em; font-size: {{ $fsHeading }};color:rgb(9, 66, 163);">기관 이슈 및 논의 사항</h3>
<pre style="white-space: pre-wrap; margin: 0; padding: 12px; background:rgb(255, 255, 255); border-radius: 6px; font-size: {{ $fs }}; font-family: sans-serif;">{{ $supportRecord->TO_Account ?: '—' }}</pre>
