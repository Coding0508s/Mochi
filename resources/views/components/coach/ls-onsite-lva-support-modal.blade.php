    ...
    <div class="mochi-modal-overlay {{ $viewOnly ? 'z-[70]' : 'z-[60]' }}" wire:click.self="closeLsOnsiteLvaModal">
        <div class="mochi-modal-shell max-w-5xl max-h-[95vh] min-h-0 flex flex-col" @click.stop>
            <x-admin.modal-header
                :title="$lsOnsiteLvaConfig['modal_title'] ?? 'TR 교사지원LittleSEEDOnSite'"
                :subtitle="$lsOnsiteLvaConfig['section_title'] ?? 'LittleSEED On-Site & LVA'"
                close-action="closeLsOnsiteLvaModal"
            />
