    ...
    <div class="mochi-modal-overlay {{ $viewOnly ? 'z-[70]' : 'z-[60]' }}" wire:click.self="closeUnit21PlusModal">
        <div class="mochi-modal-shell max-w-5xl max-h-[95vh] min-h-0 flex flex-col" @click.stop>
            <x-admin.modal-header
                :title="$unit21PlusConfig['modal_title'] ?? 'TR 교사지원U21'"
                :subtitle="$unit21PlusConfig['section_title'] ?? 'Unit21+(Training+Practice Teaching)'"
                close-action="closeUnit21PlusModal"
            />
