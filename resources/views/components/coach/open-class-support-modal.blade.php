    ...
    <div class="mochi-modal-overlay {{ $viewOnly ? 'z-[70]' : 'z-[60]' }}" wire:click.self="closeOpenClassModal">
        <div class="mochi-modal-shell max-w-5xl max-h-[95vh] min-h-0 flex flex-col" @click.stop>
            <div class="flex items-center justify-between px-6 py-4 border-b bg-gradient-to-r from-blue-50/80 to-white shrink-0">
                <div>
                    <h3 class="text-lg font-semibold text-blue-700">{{ $openClassConfig['modal_title'] ?? 'TR 교사지원OpenClass' }}</h3>
                    <p class="text-xs text-gray-500 mt-0.5">{{ $openClassConfig['section_title'] ?? 'Open-Class' }}</p>
                </div>
                <button type="button" wire:click="closeOpenClassModal"
            ...
            <div class="mochi-modal-body-scroll px-6 py-4">
                ...
                <section class="bg-white border border-gray-200 rounded-lg overflow-hidden shadow-sm">
                    <div class="px-4 py-2.5 bg-blue-50 border-b border-blue-100 text-sm font-semibold text-blue-800">지원 내용</div>
                ...
                <section class="bg-white border border-gray-200 rounded-lg overflow-hidden shadow-sm">
                    <div class="px-4 py-2.5 bg-blue-50 border-b border-blue-100 text-sm font-semibold text-blue-800">비고</div>
                    <div class="p-4">
