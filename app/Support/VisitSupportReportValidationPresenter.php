...
final class VisitSupportReportValidationPresenter
{
    ...
    public static function messages(): array
    {
        return [
            ...
            'observe_rows.*.unit.integer' => 'Unit은 0~99 사이 숫자로 입력해 주세요.',
            'observe_rows.*.unit.min' => 'Unit은 0~99 사이 숫자로 입력해 주세요.',
            'observe_rows.*.unit.max' => 'Unit은 0~99 사이 숫자로 입력해 주세요.',
            'observe_rows.*.lesson.integer' => 'Lesson은 0~99 사이 숫자로 입력해 주세요.',
            'observe_rows.*.lesson.min' => 'Lesson은 0~99 사이 숫자로 입력해 주세요.',
            'observe_rows.*.lesson.max' => 'Lesson은 0~99 사이 숫자로 입력해 주세요.',
