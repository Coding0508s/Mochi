...
class StoreTeacherOpenClassSupportReport
{
    /**
     * @param  array<string, mixed>  $data
     */
    public function execute(int $teacherId, array $data, User $user): TeacherOpenClassSupportReport
    {
        ...
        return DB::transaction(function () use ($teacher, $validated, $user, $status, $markCompleted): TeacherOpenClassSupportReport {
            ...
            return TeacherOpenClassSupportReport::query()->create([
    ...
    private function authorize(Teacher $teacher, User $user): void
    {
        ...
        if (! $query->exists()) {
            throw new AuthorizationException('이 교사에 대한 Open-Class 보고서를 작성할 권한이 없습니다.');
        }
    }
    ...
    private function validate(array $data): array
    {
        return Validator::make($data, [
            ...
            'procedures.*' => ['string'],
            'support_content' => ['nullable', 'array'],
